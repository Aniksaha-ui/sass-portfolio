...
class SubcategoryController extends Controller
{
    ...
    {
        return $this->respond(true, 'Subcategories fetched successfully', $this->subcategories->paginate(min(max((int) $request->query('perPage', 10), 1), 100), max((int) $request->query('page', 1), 1), (string) $request->query('search', '')));
    }

    public function options()
    {
        return $this->respond(true, 'Category options fetched successfully', $this->subcategories->options());
    }
    ...
    {
        return $this->subcategories->delete($id) ? $this->respond(true, 'Subcategory deleted successfully', []) : $this->respond(false, 'Subcategory not found', [], 404);
    }
    ...
    private function found($subcategory)
    {
        return $subcategory ? $this->respond(true, 'Subcategory fetched successfully', $subcategory) : $this->respond(false, 'Subcategory not found', [], 404);
    }
